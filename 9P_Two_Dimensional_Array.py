...
two_D_Array = np.array([[11, 12, 13, 14], [21, 22, 23, 24], [31, 32, 33, 34], [41, 42, 43, 44]])
...
new_2D_Array = np.insert(two_D_Array, 0, [[1, 2, 3, 4]], axis=0) #0 for row and 1 for column

new_2D_Array = np.append(two_D_Array, [[51, 53, 53, 54]], axis=0) # Using append we can add column or row at last
